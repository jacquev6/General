...
PLEASE_USE((==), Equate__Phys__equal)
PLEASE_USE((!=), Equate__Phys__different)
...
PLEASE_USE((|>), Function1__rev_apply)
PLEASE_USE((@@), Function1__apply)

(* Integer arithmetics *)
PLEASE_USE((~-), Int__negate)
PLEASE_USE((~+), Function1__identity)
...
PLEASE_USE_TYPE(out_channel, OutChannel__t)
PLEASE_USE(stdin, StdIn__channel)
PLEASE_USE(stdout, StdOut__channel)
PLEASE_USE(stderr, StdErr__channel)

(* Output functions on standard output *)
PLEASE_USE(print_char, StdOut__print)
PLEASE_USE(print_string, StdOut__print)
PLEASE_USE(print_bytes, StdOut__print)
PLEASE_USE(print_int, StdOut__print)
PLEASE_USE(print_float, StdOut__print)
PLEASE_USE(print_endline, StdOut__print)
PLEASE_USE(print_newline, StdOut__print)

(* Output functions on standard error *)
PLEASE_USE(prerr_char, StdErr__print)
PLEASE_USE(prerr_string, StdErr__print)
PLEASE_USE(prerr_bytes, StdErr__print)
PLEASE_USE(prerr_int, StdErr__print)
PLEASE_USE(prerr_float, StdErr__print)
PLEASE_USE(prerr_endline, StdErr__print)
PLEASE_USE(prerr_newline, StdErr__print)
...
PLEASE_USE(open_out, OutFile__with_file)
PLEASE_USE(open_out_bin, OutFile__with_file)
PLEASE_USE(open_out_gen, OutFile__with_file)
PLEASE_USE(flush, OutChannel__flush)
PLEASE_USE(flush_all, todo)
PLEASE_USE(output_char, OutChannel__print)
PLEASE_USE(output_string, OutChannel__print)
PLEASE_USE(output_bytes, OutChannel__output)
PLEASE_USE(output, OutChannel__output)
PLEASE_USE(output_substring, OutChannel__output)
PLEASE_USE(output_byte, OutChannel__output)
PLEASE_USE(output_binary_int, OutChannel__output)
PLEASE_USE(output_value, OutChannel__output)
PLEASE_USE(seek_out, OutFile__seek)
PLEASE_USE(pos_out, OutFile__pos)
PLEASE_USE(out_channel_length, OutFile__size)
PLEASE_USE(close_out, OutFile__with_file)
PLEASE_USE(close_out_noerr, todo)
PLEASE_USE(set_binary_mode_out, todo)

(* General input functions *)
PLEASE_USE(open_in, InFile__with_file)
PLEASE_USE(open_in_bin, InFile__with_file)
PLEASE_USE(open_in_gen, InFile__with_file)
...
PLEASE_USE(seek_in, InFile__seek)
PLEASE_USE(pos_in, InFile__pos)
PLEASE_USE(in_channel_length, InFile__size)
PLEASE_USE(close_in, InFile__with_file)
...
PLEASE_USE(valid_float_lexem, Standard__OCamlStandard__Pervasives__valid_float_lexem)
PLEASE_USE(unsafe_really_input, Standard__OCamlStandard__Pervasives__unsafe_really_input)
PLEASE_USE(do_at_exit, Standard__OCamlStandard__Pervasives__do_at_exit)
