module Tuple2 = struct
  ...
  let repr (x, y) ~repr_a ~repr_b =
    Format_.sprintf "(%s, %s)" (repr_a x) (repr_b y)
end
...
module Tuple3 = struct
  ...
  let repr (x, y, z) ~repr_a ~repr_b ~repr_c =
    Format_.sprintf "(%s, %s, %s)" (repr_a x) (repr_b y) (repr_c z)
end
...
module Tuple4 = struct
  ...
  let repr (x, y, z, u) ~repr_a ~repr_b ~repr_c ~repr_d =
    Format_.sprintf "(%s, %s, %s, %s)" (repr_a x) (repr_b y) (repr_c z) (repr_d u)
end
...
module Tuple5 = struct
  ...
  let repr (x, y, z, u, v) ~repr_a ~repr_b ~repr_c ~repr_d ~repr_e =
    Format_.sprintf "(%s, %s, %s, %s, %s)" (repr_a x) (repr_b y) (repr_c z) (repr_d u) (repr_e v)
end
