...
(* Comparisons *)
PLEASE_USE((=), Equate__Poly__equal__todo)
PLEASE_USE((<>), Compare__Poly__different__todo)
PLEASE_USE((<), Compare__Poly__less_than__todo)
PLEASE_USE((>), Compare__Poly__greater_than__todo)
PLEASE_USE((<=), Compare__Poly__less_or_equal__todo)
PLEASE_USE((>=), Compare__Poly__greater_or_equal__todo)
PLEASE_USE(compare, Compare__Poly__compare)
PLEASE_USE(min, Compare__Poly__min__todo)
PLEASE_USE(max, Compare__Poly__max__todo)
PLEASE_USE((==), Equate__Physical__equal__todo)
PLEASE_USE((!=), Equate__Physical__different__todo)
